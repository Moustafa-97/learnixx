        ...
        <div className={styles.section}>
          ...
          <div className={styles.cards1}>
            <div className={styles.largeCard}>
              ...
              <p>{t("cards.globalConnections.description")}</p>
              <button onClick={handleNavigation}>
                {t("cards.globalConnections.buttonText")}
              </button>
            </div>
          ...
          <div className={styles.videoContainer}>
            <video autoPlay loop muted playsInline className={styles.video}>
              <source
                src="https://yllaaa-bucket.fra1.cdn.digitaloceanspaces.com/learnix/uploads/Untitled%20design%20(2)%20copia.mp4"
                type="video/mp4"
              />
            </video>
          </div>
          <div className={styles.cards2}>
            ...
            <div className={styles.largeCard}>
              ...
              <p>{t("cards.practicalTrainers.description")}</p>
              <button onClick={handleNavigation}>
                {t("cards.practicalTrainers.buttonText")}
              </button>
            </div>
          </div>
        </div>
