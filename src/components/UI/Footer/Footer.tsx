  ...
  const links = [
    {
      ...
      sections: [
        ...
        { name: t('navigation.home.whyLearnix'), link: `/${locale}/why-learnix` },
        { name: t('navigation.home.topCourses'), link: `/${locale}/top-courses` },
        { name: t('navigation.home.testimonials'), link: `/${locale}/testimonials` },
    ...
    },
    {
      ...
      sections: [
        { name: t('navigation.about.howItWorks'), link: `/${locale}/how-it-works` },
        { name: t('navigation.about.testimonials'), link: `/${locale}/testimonials` },
    ...
    },
    {
      ...
      sections: [
        { name: t('navigation.cities.explore'), link: `/${locale}/explore-cities` },
        { name: t('navigation.cities.madrid'), link: `/${locale}/explore-cities?city=madrid` },
        { name: t('navigation.cities.paris'), link: `/${locale}/explore-cities?city=paris` },
      ],
    },
  ]
